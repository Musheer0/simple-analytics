            ...
            appearance={{
              elements: {
                ...
                organizationPreviewTextContainer:
                  "group-data-[collapsible=icon]:hidden! text-xs! text-sidebar-foreground! font-medium! ",
                organizationSwitcherTriggerIcon:
                  "group-data-[collapsible=icon]:hidden! ml-auto",
              },
            }}
          />
        </SidebarGroupContent>
        ...
        <UserButton
          ...
          appearance={{
            elements: {
              rootBox: "w-full! h-8!",
              userButtonTrigger:
                "w-full! p-2! hover:bg-sidebar-accent! hovr:text-sidebar-accent-foreground! group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2!",
              userButtonBox:
