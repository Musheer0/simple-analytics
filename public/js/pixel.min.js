document.addEventListener(
  ...
  (async function () {
    ...
    if (((window.__PIXEL_LOADED__ = !0), "undefined" == typeof window)) return;
    ...
    const l = (t, n, o) => {
        ...
        o
          ...
          : navigator.sendBeacon
            ? navigator.sendBeacon(e + "/collect", i)
            : fetch(e + "/collect", {
                method: "POST",
                body: h(t, n),
                headers: { "Content-Type": "application/json" },
      ...
      u = () => {
        n.push(location.href),
          n.length >= 5 && (l("path_change", { path_history: n }), (n = []));
      };
    (history.pushState = function (...e) {
      ...
      window.addEventListener("pagehide", () => {
        console.log(n),
          (a += performance.now() - i),
          l("page_exit", { active_time: Math.round(a), path_history: n });
      });
  })(),
);
